...
from lib.bitcoin.core.key import CPubKey
from lib.bitcoin.core.serialize import ImmutableSerializable
from lib.bitcoin.wallet import P2PKHBitcoinAddress
import bitcoin
import base64
import sys
...
class BitcoinMessage(ImmutableSerializable):
    ...
    def stream_deserialize(cls, f):
        magic = lib.bitcoin.core.serialize.BytesSerializer.stream_deserialize(f)
        message = lib.bitcoin.core.serialize.BytesSerializer.stream_deserialize(f)
        return cls(message, magic)

    def stream_serialize(self, f):
        lib.bitcoin.core.serialize.BytesSerializer.stream_serialize(self.magic, f)
        lib.bitcoin.core.serialize.BytesSerializer.stream_serialize(self.message, f)
