...
B4ARGS="-datadir=$D4"
$BITCREDITSD $BITCREDITSDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$BITCREDITSD $BITCREDITSDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $BITCREDITSD $BITCREDITSDARGS $B1ARGS &
  B1PID=$!
  $BITCREDITSD $BITCREDITSDARGS $B2ARGS &
  B2PID=$!
  $BITCREDITSD $BITCREDITSDARGS $B3ARGS &
  B3PID=$!
}
