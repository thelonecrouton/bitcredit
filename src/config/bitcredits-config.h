/* src/config/bitcredits-config.h.  Generated from bitcredits-config.h.in by configure.  */
/* src/config/bitcredits-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCREDITS_CONFIG_H

#define BITCREDITS_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@bitcredits.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcredits Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcredits Core 1.1.02"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcredits"

/* Define to the home page for this package. */
#define PACKAGE_URL ""

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.2.06"
