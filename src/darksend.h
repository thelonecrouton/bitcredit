...
{
public:
    static const int MIN_PEER_PROTO_VERSION = 70088;
    ...
    bool AddEntry(const std::vector<CTxIn>& newInput, const int64_t& nAmount, const CMutableTransaction& txCollateral, const std::vector<CTxOut>& newOutput, std::string& error);
    ...
    // get the denominations for a specific amount of bitcredit.
