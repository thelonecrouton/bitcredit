...
#if defined(NDEBUG)
# error "Bitcredits cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bitcredits Signed Message:\n";
...
CAmount GetBlockValue(int nHeight, const CAmount& nFees)
{
    ...
    // Subsidy is cut in half every 20,000 blocks which will occur approximately every 4 weeks.
    nSubsidy >>= halvings;
...
void ThreadScriptCheck() {
    RenameThread("bitcredits-scriptch");
