...
typedef void (*vg_output_match_func_t)(vg_context_t *vcp, EC_KEY *pkey, const char *pattern);
...
extern vg_context_t *vg_prefix_context_new(int addrtype, int privtype, int caseinsensitive);
extern void vg_prefix_context_set_case_insensitive(vg_context_t *vcp, int caseinsensitive);
...
extern void vg_output_match_console(vg_context_t *vcp, EC_KEY *pkey, const char *pattern);
