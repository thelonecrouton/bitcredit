    ...
    tab(tab)
{
    ...
    case ForSelection:
        switch(tab)
        {
        case CommercialTab: setWindowTitle(tr("These represent other bank users")); break;
        case InvestmentTab: setWindowTitle(tr("These represent other Banks")); break;
        }
    ...
    case ForEditing:
        switch(tab)
        {
        case CommercialTab: setWindowTitle(tr("Sending addresses")); break;
        case InvestmentTab: setWindowTitle(tr("Receiving addresses")); break;
        }
        break;
    }
    switch(tab)
