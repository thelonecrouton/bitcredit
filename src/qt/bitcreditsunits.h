...
#ifndef BITCREDITSUNITS_H
#define BITCREDITSUNITS_H
...
/** Bitcredits unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcreditsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcreditsUnits(QObject *parent);

    /** Bitcredits units.
      @note Source: https://en.bitcredits.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BCR,
...
typedef BitcreditsUnits::Unit BitcreditsUnit;

#endif // BITCREDITSUNITS_H
