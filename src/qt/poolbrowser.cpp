...
void PoolBrowser::parseBittrexHistory(QNetworkReply *replay)
{
    ...
    if (jsonResponse.isObject()) {
       ...
       if (mainObject.contains("result")) {
           ...
           ui->tradesBittrexTable->setColumnWidth(2,  100);
           ui->tradesBittrexTable->setColumnWidth(3,  100);
