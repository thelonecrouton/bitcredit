...
#include "config/bitcredits-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcreditsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitcreditsUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcreditsURI(info));
}
