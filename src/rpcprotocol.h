...
#ifndef _BITCREDITSRPC_PROTOCOL_H_
#define _BITCREDITSRPC_PROTOCOL_H_
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Bitcredits is not connected
...
#endif // _BITCREDITSRPC_PROTOCOL_H_
