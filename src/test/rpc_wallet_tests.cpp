...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CBitcreditsAddress demoAddress = CBitcreditsAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CBitcreditsAddress setaccountDemoAddress = CBitcreditsAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CBitcreditsAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcreditsAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
